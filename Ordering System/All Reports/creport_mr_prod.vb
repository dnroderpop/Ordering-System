...
Public Class creport_mr_prod
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordering_System.creport_mr_prod.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcreport_mr_prod
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As creport_mr_prod = New creport_mr_prod()
        rpt.Site = Me.Site
        Return rpt
    End Function

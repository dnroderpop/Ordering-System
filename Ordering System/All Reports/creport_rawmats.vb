...
Public Class creport_rawmats
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordering_System.creport_rawmats.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcreport_rawmats
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As creport_rawmats = New creport_rawmats()
        rpt.Site = Me.Site
        Return rpt
    End Function

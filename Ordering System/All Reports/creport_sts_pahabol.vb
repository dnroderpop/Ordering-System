...
Public Class creport_sts_pahabol
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "creport_sts_pahabol.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordering_System.creport_sts_pahabol.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcreport_sts_pahabol
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As creport_sts_pahabol = New creport_sts_pahabol()
        rpt.Site = Me.Site
        Return rpt
    End Function

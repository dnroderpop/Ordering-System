...
Public Class creport_excel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordering_System.creport_excel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcreport_excel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As creport_excel = New creport_excel()
        rpt.Site = Me.Site
        Return rpt
    End Function

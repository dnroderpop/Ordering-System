...
Public Class creport_products
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordering_System.creport_products.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcreport_products
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As creport_products = New creport_products()
        rpt.Site = Me.Site
        Return rpt
    End Function

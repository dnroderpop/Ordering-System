...
Public Class creport_deped
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordering_System.creport_deped.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcreport_deped
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As creport_deped = New creport_deped()
        rpt.Site = Me.Site
        Return rpt
    End Function

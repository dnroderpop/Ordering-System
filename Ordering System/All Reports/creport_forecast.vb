...
Public Class creport_forecast
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordering_System.creport_forecast.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcreport_forecast
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As creport_forecast = New creport_forecast()
        rpt.Site = Me.Site
        Return rpt
    End Function

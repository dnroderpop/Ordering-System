...
Public Class creport_sts_order
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordering_System.creport_sts_order.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcreport_sts_order
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As creport_sts_order = New creport_sts_order()
        rpt.Site = Me.Site
        Return rpt
    End Function

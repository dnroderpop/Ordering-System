...
Public Class creport_checksum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordering_System.creport_checksum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcreport_checksum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As creport_checksum = New creport_checksum()
        rpt.Site = Me.Site
        Return rpt
    End Function

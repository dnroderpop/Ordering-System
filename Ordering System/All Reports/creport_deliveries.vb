...
Public Class creport_deliveries
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ordering_System.creport_deliveries.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcreport_deliveries
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As creport_deliveries = New creport_deliveries()
        rpt.Site = Me.Site
        Return rpt
    End Function

Public Class resources_branch
    ...
    Sub function_reset()
        Lmat.Text = "Selected Branch"
        Ladd.Text = "Add a Branch"
    ...
    Private Sub btn_delete_Click(sender As Object, e As EventArgs) Handles btn_delete.Click
        If connn.msgboxc("Are you sure to delete [" & selectedid & "] ?", 3) Then
            If connn.sql_customSQLCOMMAND("update source_branch set able = 0 where id = " & selectedid) Then
                function_reset()
                loadtable()
            End If
        End If
    ...
    Private Sub btn_update_Click(sender As Object, e As EventArgs) Handles btn_update.Click
        ...
        Else
            Dim sqlstring As String = "UPDATE `source_branch` SET `name`='[value-2]' where id = '" & selectedid & "'"
    ...
    Private Sub btn_add_Click(sender As Object, e As EventArgs) Handles btn_add.Click
        ...
        Else
            ...
            If connn.sql_insertdatatotable("source_branch", "`name`,`able`", values) Then
                function_reset()
                loadtable()
                connn.msgboxc("Success!", 1)
            End If
    ...
    Private Sub resources_branch_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loadtable()
    End Sub
End Class
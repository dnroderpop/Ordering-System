...
Public Class report_generate_deped
    Public sts, time, branch, qdate, batch As String
    Public data As DataTable
    Private Sub report_generate_deped_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim filelocation As String = "report\creport_deped.rpt"
